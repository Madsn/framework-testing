...
import net.madsn.frameworktest.jhipster.domain.User;
import net.madsn.frameworktest.jhipster.repository.AuthorityRepository;
import net.madsn.frameworktest.jhipster.repository.UserRepository;
import net.madsn.frameworktest.jhipster.security.AuthoritiesConstants;
import net.madsn.frameworktest.jhipster.service.MailService;
import net.madsn.frameworktest.jhipster.service.UserService;
import net.madsn.frameworktest.jhipster.web.rest.dto.UserDTO;
